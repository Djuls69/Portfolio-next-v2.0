...
Sitemap: http://www.juliendelusseau.fr/sitemap_local.xml
Disallow:`
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ${Object.keys(pathsObj)
    .filter(path => path !== '/index' && path !== '/_app')
    .map(
      path => `<url>
    ${
      path === '/index' ? `<loc>http://www.juliendelusseau.fr</loc>` : `<loc>http://www.juliendelusseau.fr${path}</loc>`
    }
